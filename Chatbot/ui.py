...
import threading
import uuid
from parent_chat import *  # Imports your LLM and DB functions
...
class ChatBubble(ctk.CTkFrame):
    def __init__(self, parent, message, is_user=False, bubble_bg=None, **kwargs):
        ...
        # Create a horizontal frame for avatar and role label
        ...
        # Message label below header in its own frame
        self.message_label = ctk.CTkLabel(self, text=message, font=ModernTheme.CHAT_FONT, wraplength=600, justify="left", fg_color=bg_color, text_color=ModernTheme.TEXT_COLOR)
...
class NurseChatApp:
    def __init__(self, root):
        self.root = root
        self.root.title("NICU Parent Chat")
    ...
    def _create_sidebar(self):
        # Sidebar header
        self.logo_label = ctk.CTkLabel(self.sidebar, text="Parent Chat", font=("Inter", 16, "bold"), text_color=ModernTheme.TEXT_COLOR)
        ...
        # Version info
        self.version_label = ctk.CTkLabel(self.sidebar, text="Parent Chatbot V11 - SYSC4907", font=("Inter", 9), text_color=ModernTheme.SECONDARY_TEXT)
    ...
    def _add_welcome_message(self):
        welcome_message = (
            ...
            "To begin, please select your child's data file from the sidebar. "
            "Once a file is selected, you can ask questions about your precious child's vital signs and condition."
        )
        bubble = ChatBubble(self.scrollable_frame,
                            welcome_message,
                            is_user=False,
                            bubble_bg=ModernTheme.WELCOME_BUBBLE_BG)
